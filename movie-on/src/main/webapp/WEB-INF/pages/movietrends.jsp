		...
		<div class="tab-content">
			<div id="home" class="tab-pane fade in active">
				<c:forEach var="movie1" items="${horrorList}">
					...
					<div class="row">
						...
						<tr>
							<td><h4>Movie Name: ${movie1.moviename}</h4>
								<h5> rate: ${movie1.rate}</h5>
							</td>
			...
			<div id="menu1" class="tab-pane fade">
				<c:forEach var="movie2" items="${actionList}">
					...
					<div class="row">
						...
						<tr>
							<td><h4>Movie Name: ${movie2.moviename}</h4>
								<h5> rate: ${movie2.rate}</h5>
							</td>
						</tr>
						<tr>
			...
			<div id="menu2" class="tab-pane fade">
				<c:forEach var="movie3" items="${comedyList}">
					...
					<div class="row">
						...
						<tr>
							<td><h4>Movie Name: ${movie3.moviename}</h4>
								<h5> rate: ${movie3.rate}</h5>
							</td>
						</tr>
						<tr>
			...
			<div id="menu3" class="tab-pane fade">
				<c:forEach var="movie4" items="${adventureList}">
					...
					<div class="row">
						...
						<tr>
							<td><h4>Movie Name: ${movie4.moviename}</h4>
								<h5> rate: ${movie4.rate}</h5>
							</td>
						</tr>
						<tr>
							<c:forEach var="video4" items="${movie4.videoresult}">
								<td><iframe title="YouTube video player"
										class="youtube-player" type="text/html"
										src="http://www.youtube.com/embd/${video4.videoId}"
										frameborder="0" allowFullScreen></iframe></td>
							</c:forEach>
						</tr>
			...
			<c:forEach var="movie5" items="${animationList}">
				...
				<div class="row">
					...
					<tr>
						<td><h4 class="address-bar">Movie Name: ${movie5.moviename}</h4>
							<h5 class="address-bar"> rate: ${movie5.rate}</h5>
						</td>
					</tr>
					<tr>
